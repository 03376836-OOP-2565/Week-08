...
```
![image](https://github.com/PiyatidaPh/Week-08/assets/115066285/99825f27-bfe3-4201-9c09-a0516d21f3e3)
...
```
![image](https://github.com/PiyatidaPh/Week-08/assets/115066285/4fa3d35d-29fc-42f0-874d-74acfdcaa9a3)
...
```
```
1. ประกาศ class Cat โดยกำหนด stance member คือ legs และ static member คือ count 
...
9. สร้าง array ของ class Cat โดยให้ array โดยกำหนดขนาดของ array ให้เท่ากับ 10
...
```
![image](https://github.com/PiyatidaPh/Week-08/assets/115066285/78e4a6a9-9600-4ecd-b461-06385c6f4ac3)
...
```
```
โปรแกรมไม่สามารถรันได้เนื่องจากไม่สามารถเรียกใช้ method ผ่านชื่อตัวแปรได้เนื่องจากเป็น static method จึงต้องเรียกใช้ผ่าน class เท่านั้น
```
![image](https://github.com/PiyatidaPh/Week-08/assets/115066285/c1d1718f-e772-408b-8cc7-e60ca8868059)


## คำถาม

1. Static member ต่างจาก instance member  อย่างไร
static member คือตัวแปรหรือmethod สามารถเรียกใช้งานได้โดยสร้าง พิมพ์ชื่อคลาสและตามด้วยชื่อตัวแปรหรือmethod ส่วน Instance คือตัวแปรหรือmethod เหมือนกันแต่ต่างกันตรงที่ Instance คือตัวแปรหรือmethodที่อยู่ในคลาสสามารถเรียกใช้งานได้โดยสร้างobject และเรียกใช้งาน method หรือตัวแปร
2. สถานการณ์ใดที่ควรใช้ static member
เมื่อต้องการให้ค่าของตัวแปรหรือ method ใน class นั้นๆสามารถเข้าถึงได้โดยไม่ต้องสร้าง object ขึ้นมาก่อน
